// ==UserScript==
// @name         X Video Downloader - DOM Mode Fixed (Firefox Android)
// @namespace    http://tampermonkey.net/
// @version      6.1
// @description  Download video X/Twitter termasuk dari akun terkunci - Fixed video playback
// @author       Assistant
// @match        https://x.com/*
...
(function() {
    ...
    // ========== DOWNLOAD VIDEO VIA XHR ==========
    function downloadVideoBlob(url, filename) {
        toast('⏳ Memproses download...');
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) {
                try {
                    ...
                    toast('Download gagal, coba buka di tab baru', true);
                }
            },
            onerror: function() {
                toast('Download gagal, coba buka di tab baru', true);
            ...
            ontimeout: function() {
                toast('Timeout, coba buka di tab baru', true);
            }
        });
    }
    ...
    function showResult(data) {
        ...
        if (isProtected) {
            instructionHTML = `
                <div class="xvd-instruction warning">
                    ...
                    <div class="xvd-instruction-main">VIDEO DARI AKUN TERKUNCI</div>
                    <div class="xvd-instruction-sub">Gunakan metode "Buka Tab Baru" untuk download</div>
                </div>
            `;
            
            downloadButtonHTML = `
                <div class="xvd-info-banner warning">
                    <div class="xvd-info-title warning">📱 Cara Download Terbaik:</div>
                    <div class="xvd-info-text">
                        <strong>1. Tekan tombol "Buka di Tab Baru"</strong><br>
                        <strong>2. Di tab baru, tekan tahan pada video</strong><br>
                        <strong>3. Pilih "Save video" atau "Download video"</strong>
                    </div>
                </div>
            ...
            instructionHTML = `
                <div class="xvd-instruction">
                    ...
                    <div class="xvd-instruction-main">PILIH METODE DOWNLOAD</div>
                    <div class="xvd-instruction-sub">Gunakan tombol hijau atau buka tab baru</div>
                </div>
            `;
            
            downloadButtonHTML = `
                <button class="xvd-download-btn" id="xvd-download-btn">
        ...
        setBody(`
            ...
            <div class="xvd-info-banner">
                ...
                <div class="xvd-info-text">
                    ${mode === 'dom' ? 
                        '🔒 Video dari akun terkunci - Buka di tab baru untuk download' : 
                        '✅ Video publik - Download langsung tersedia'
                    }
                </div>
            </div>

            <div class="xvd-steps">
                <div class="xvd-steps-title">📱 Cara Download:</div>
                ${isProtected ? `
                    <div class="xvd-step">
                        <span class="xvd-step-num">1</span>
                        <span>Tekan tombol <strong>"Buka di Tab Baru"</strong></span>
                    </div>
                    <div class="xvd-step">
                        <span class="xvd-step-num">2</span>
                        <span><strong>Tekan tahan video</strong> yang muncul</span>
                    </div>
                    <div class="xvd-step">
                        <span class="xvd-step-num">3</span>
                        <span>Pilih <strong>"Save video"</strong></span>
                    </div>
                ` : `
                    <div class="xvd-step">
                        <span class="xvd-step-num">1</span>
                        <span>Tekan tombol hijau <strong>"DOWNLOAD LANGSUNG"</strong></span>
                    </div>
                    <div class="xvd-step">
                        <span class="xvd-step-num">2</span>
                        <span>Atau tekan <strong>"Buka di Tab Baru"</strong> lalu save video</span>
                    </div>
                    <div class="xvd-step">
                        <span class="xvd-step-num">3</span>
        ...
        // Event handlers
        const downloadBtn = document.getElementById('xvd-download-btn');
        if (downloadBtn) {
            downloadBtn.onclick = () => {
                downloadVideoBlob(v.url, filename);
            };
        }
    ...
    async function processUrl(url) {
        ...
        // PRIORITAS 1: Coba ambil dari DOM dulu
    ...
    // ========== INIT ==========
    function init() {
        console.log('🔥 X Video Downloader v6.1 - DOM MODE FIXED');
        console.log('📋 Fitur: DOM Direct + XHR Download + Tab Baru');
        createFab();
        addVideoButtons();
